...
***
MKlon2. Как это работает. Межпроцессорное соединение. 
...
***
MKlon2. Как это работает. Измерители.
...
***
MKlon2. Как это работает. Вычисление среднего.
...
***
MKlon2. Как это работает. Схема разряда.
...
***
MKlon2. Как это работает. Подключение заряжаемой батареи.
...
***
MKlon2. Как это работает. Питание микроконтроллеров.
...
***
MKlon2. Как это работает. Силовой DC/DC преобразователь.
...
***
MKlon2. Как это работает. Подключение вентилятора.
