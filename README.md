...
2. Найдите в папке modes файлы templatefsm.h и templatefsm.cpp с примером реализации режима в ту же папку но под названием вашего режима, произведя обязательные изменения в следующих стоках:
файл templatefsm.h
```c++
