...
В директории src представлены только упомянутые в данном репозитории файлы для ознакомления с особенностями реализации проекта. Полный комплект в репозитории MKlon2.8.
...
- status_switch           = 1U<<15; 
- status_power            = 1U<<14; 
- status_current_control  = 1U<<13; 
- status_voltage_control  = 1U<<12; 
- status_charge           = 1U<<11; 
- status_discharge        = 1U<<10; 
- status_auto_mode        = 1U<<9; 
- status_pid              = 1U<<8;
- status_overheating      = 1U<<7; 
- status_overload         = 1U<<6; 
- status_power_limit      = 1U<<5; 
- status_reverse_polarity = 1U<<4; 
- status_short_circuit    = 1U<<3; 
- status_calibration      = 1U<<2; 
- status_upgrade          = 1U<<1; 
- status_reserve2         = 1U; 
