...
#### <p align="right">2023.04.15 добавлены команды
#### <p align="right">2023.04.18 добавлен пульт-логгер
#### <p align="right">2023.04.20 добавлен драйвер SAMD21
#### <p align="right">2023.04.21 добавлен режим ХХ
...
пид-регулятор периодически отключает преобразователь. Но ШИМ при этом 50/50, что соответствует отдаче половины максимальной мощности, ток в режиме CC и напряжение в режиме CV поддерживаются в заданных параметрах плюс-минус 2 миллиампера и 2 милливольта, работа преобразователя устойчива:
![](https://github.com/olmoro/MKlon4.0/blob/main/documents/samd/docs/img/50_50.png)

через 5 миллисекунд генерация возобновляется:
![](https://github.com/olmoro/MKlon4.0/blob/main/documents/samd/docs/img/off_5ms.png)
...
![](https://github.com/olmoro/MKlon4.0/blob/main/documents/samd/docs/img/idling.png)

Никаких специальных настроек - в режиме холостого хода на клеммах поддерживалось напряжение в пределах 13.0-14.0 вольт при установленном 13.5 уровне. Подключение батареи не сопровождалось искрением, выход в режим поддержания напряжения прошел штатно.

И, наконец, вишенка на торте - задействованные аналоговые входы измерителей тока и напряжения не случайно оказались именно теми же, к которым подключены встроенные аналоговые компараторы SAMD21. Не ожидали такого подарка? Я тоже.
[^](#menu)
***
