...
- Интерфейс ____________________________ USB, WiFi, BT
- Индикация ____________________________ TFT 3.5 или 4.0, сенсорная панель 
- Диагностика __________________________ 2 разъема для логического анализатора
- Micro-SD карта _______________________ на дисплее
- Защита по выходу _____________________ переполюсовка, перегрузка по току, КЗ
